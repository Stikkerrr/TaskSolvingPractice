 ...
 *
 * Научимся создавать и заполнять массив. Мы уже знаем что необходимо при создании указать количество рядов и
 * количество элементов в каждом ряду. Однако это является не обязательным, если сразу при объявлении заполнить массив.
